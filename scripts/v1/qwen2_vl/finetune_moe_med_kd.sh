...
deepspeed --include=localhost:2,3 --master_port=29502 moellava/train/train_mem.py \
    ...
    --k_experts_path /mnt/data/haoqiang/workspace/05-moe-llava/checkpoints/qwen2-vl-2b-instruct-6e2-med-nano-ds-tok-3epoch \
    --from_pretrained False \
    --from_pretrained_path /mnt/data/haoqiang/workspace/05-moe-llava/checkpoints/qwen2-vl-2b-instruct-6e2-med-nano-ds-tok-share-5epoch/pytorch_model.bin \
